...
<?php $this->beginBody() ?>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= Url::to(['/']) ?>">
                        <img src="<?= Yii::$app->request->baseUrl ?>theme/img/logo.png" class="logo logo-display" alt="Logo">
                        <img src="<?= Yii::$app->request->baseUrl ?>theme/img/logo.png" class="logo logo-scrolled" alt="Logo">
                    </a>
                </div>
    ...
    <div class="breadcrumb-area shadow dark bg-fixed text-center text-light" style="background-image: url(<?= Yii::$app->request->baseUrl ?>theme/img/banner/slider.jpg);">
    </div>
    <!-- End Header -->
        <?= ToastrFlash::widget([
            'options' => [
